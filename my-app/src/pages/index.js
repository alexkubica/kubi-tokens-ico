...
export default function Home() {
  ...
  const getProviderOrSigner = async (needSigner = false) => {
    ...
    // If user is not connected to the seploia network, let them know and throw an error
  ...
  return (
    <div>
      <Head>
        <title>Kubi Sepolia ICO</title>
        <meta name="description" content="ICO-Dapp" />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className={styles.main}>
        <div>
          <h1 className={styles.title}>Welcome to Kubi ICO!</h1>
          <div className={styles.description}>
            You can claim or mint Kubi tokens here
          </div>
          {walletConnected ? (
            <div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
                You have minted {utils.formatEther(balanceOfCryptoDevTokens)} Kubi Tokens
              </div>
              <div className={styles.description}>
                {/* Format Ether helps us in converting a BigNumber to string */}
